...
struct FSamplingContext
{
	...
	UPROPERTY(VisibleAnywhere, Category = "Sampling|Preview")
	TObjectPtr<UTexture2D> NoisePreview;
	
	UPROPERTY(EditDefaultsOnly, Category = "Sampling|Preview", meta=(ClampMin = 8))
	int32 PreviewResolution = 256;
	
	UPROPERTY(EditDefaultsOnly, Category = "Sampling|Preview", meta=(UIMin = 0, UIMax = 10000))
	int32 SeedPreview = 0;
