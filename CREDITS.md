...
This project uses assets from the community to focus on C++ gameplay systems. Huge thanks to these creators:

## 🧊 3D Models & Environment
- **Quaternius** ([website](https://quaternius.com/)):
  - Copper Vein mesh: [Rock](https://poly.pizza/m/34W5ymEePk)
  - Iron Vein mesh: [Rock](https://poly.pizza/m/R2UjZAX3By)
  - Stone Vein mesh: [Rock Large](https://poly.pizza/m/d2VWOdthtR)
  - Tree, Foliage, Rocks, etc.: [Nature MegaKit](https://quaternius.itch.io/stylized-nature-megakit)
- **Lagst** ([Sketchfab](https://sketchfab.com/Lagst)):
  - Robot (Main Character): [Robot](https://sketchfab.com/3d-models/robot-435566387be94cbfbc623c3d45241769)
...
## ⚖️ License
*Note: Most assets are under CC0 or similar open licenses. Check individual creator pages for specific terms.*